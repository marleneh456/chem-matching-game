// src/components/Ch16ExerciseMatchingGame.js
...
const MatchingGame = () => {
  const chapterKey = "execrise-ch16-flashcards";
    ...
    <Document>
      {termItems.map((item, index) => (
        <Page key={index} style={styles.page}>
          {index === 0 && <Text style={styles.title}>Exercise Chapter 16</Text>}
  ...
  return (
    <div className="game-container">
      <h1>Exercise Chapter 16 Drag-and-Drop Matching Game</h1>
