// src/components/Ch17MatchingGame.js
...
const defaultItems = [
  {
    id: 1,
    term: "biomolecule",
    definition: "A general term referring to organic compounds essential to life.",
    termImage: null,
  ...
  },
  {
    id: 2,
    term: "biochemistry",
    definition: "A study of the compounds and processes associated with living organisms.",
    termImage: null,
    definitionImage: null,
  },
  {
    id: 3,
    term: "Starches like pasta, bread, and rice are examples of carbohydrates.",
    definition: null,
    termImage: null,
    definitionImage: "./ch17-images/Starches like pasta, bread, and rice are examples of carbohydrates.png",
  },
  {
    id: 4,
    term: "ribose",
    definition: null,
    termImage: null,
    definitionImage: "./ch17-images/ribose.png",
  },
  {
    id: 5,
    term: "carbohydrate",
    definition: "A polyhydroxy aldehyde or ketone, or substance that yields such compounds on hydrolysis.",
    termImage: null,
    definitionImage: null,
  },
  {
    id: 6,
    term: "monosaccharide",
    definition: "A simple carbohydrate most commonly consisting of three to six carbon atoms.",
    termImage: null,
    definitionImage: null,
  },
  {
    id: 7,
    term: "disaccharide",
    definition: "A carbohydrate formed by the combination of two monosaccharide units.",
    termImage: null,
    definitionImage: null,
  },
  {
    id: 8,
    term: "polysaccharide",
    definition: "A carbohydrate formed by the combination of many monosaccharide units.",
    termImage: null,
    definitionImage: null,
  },
  {
    id: 9,
    term: "Carbohydrate classification",
    definition: null,
    termImage: null,
    definitionImage: "./ch17-images/Carbohydrate classification.png",
  },
  {
    id: 10,
    term: "enantiomers",
    definition: "Stereoisomers that are mirror images",
    termImage: null,
    definitionImage: null,
  },
  {
    id: 11,
    term: "Enantiomers of glyceraldehyde",
    definition: null,
    termImage: null,
    definitionImage: "./ch17-images/Enantiomers of glyceraldehyde.png",
  },
  {
    id: 12,
...
const MatchingGame = () => {
  const chapterKey = "ch17-flashcards";
    ...
    <Document>
      {termItems.map((item, index) => (
        <Page key={index} style={styles.page}>
          {index === 0 && <Text style={styles.title}>Chapter 17 FlashCards</Text>}
  ...
  return (
    <div className="game-container">
      <h1>Chapter 17 Drag-and-Drop Matching Game</h1>
