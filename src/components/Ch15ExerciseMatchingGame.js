// src/components/Ch15ExerciseMatchingGame.js
...
const defaultItems = [
  ...
  },
  {
    ...
    definitionImage: "./ch12-images/Learning Check 15.5 answer.png",
  },
  {
    id: 26,
  ...
  },
  {
    ...
    definitionImage: "./ch12-images/Learning Check 15.6 answer.png",
  },
  {
    id: 35,
  ...
  },
  {
    ...
    definitionImage: "./ch12-images/Learning Check 15.7 answer.png",
  },
  {
    id: 37,
  ...
  },
  {
    ...
    definitionImage: "./ch12-images/Learning Check 15.8 answer.png",
  },
  {
    id: 39,
    term: "saponification",
...
const MatchingGame = () => {
  const chapterKey = "execrise-ch15-flashcards";
    ...
    <Document>
      {termItems.map((item, index) => (
        <Page key={index} style={styles.page}>
          {index === 0 && <Text style={styles.title}>Exercise Chapter 15</Text>}
  ...
  return (
    <div className="game-container">
      <h1>Exercise Chapter 15 Drag-and-Drop Matching Game</h1>
