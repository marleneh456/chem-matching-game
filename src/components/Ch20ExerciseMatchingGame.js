...
const MatchingGame = () => {
  const chapterKey = "execrise-ch20-flashcards";
    ...
    <Document>
      {termItems.map((item, index) => (
        <Page key={index} style={styles.page}>
          {index === 0 && <Text style={styles.title}>Exercise Chapter 20</Text>}
  ...
  return (
    <div className="game-container">
      <h1>Exercise Chapter 20 Drag-and-Drop Matching Game</h1>
