// src/components/Ch19ExerciseMatchingGame.js
...
const MatchingGame = () => {
  const chapterKey = "execrise-ch19-flashcards";
    ...
    <Document>
      {termItems.map((item, index) => (
        <Page key={index} style={styles.page}>
          {index === 0 && <Text style={styles.title}>Exercise Chapter 19</Text>}
  ...
  return (
    <div className="game-container">
      <h1>Exercise Chapter 19 Drag-and-Drop Matching Game</h1>
