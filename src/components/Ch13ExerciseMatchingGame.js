// src/components/Ch13ExerciseMatchingGame.js
...
const MatchingGame = () => {
  const chapterKey = "execrise-ch13-flashcards";
    ...
    <Document>
      {termItems.map((item, index) => (
        <Page key={index} style={styles.page}>
          {index === 0 && <Text style={styles.title}>Exercise Chapter 13</Text>}
  ...
  return (
    <div className="game-container">
      <h1>Exercise Chapter 13 Drag-and-Drop Matching Game</h1>
